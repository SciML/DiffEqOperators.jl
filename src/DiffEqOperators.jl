...
using SciMLBase:
    AbstractDiffEqLinearOperator, AbstractDiffEqCompositeOperator, DiffEqScaledOperator
import SciMLBase: getops
using SparseDiffTools
using SparseArrays,
    ForwardDiff, BandedMatrices, NNlib, LazyArrays, BlockBandedMatrices, LoopVectorization
...
@warn(
    "DiffEqOperators.jl is in the process of being deprecated.\n
...
export AbstractDerivativeOperator,
    DerivativeOperator,
    CenteredDifference,
    UpwindDifference,
    CompleteCenteredDifference,
    CompleteUpwindDifference,
    CompleteHalfCenteredDifference,
    nonlinear_diffusion,
    nonlinear_diffusion!,
    GradientOperator,
    Gradient,
