...
\begin{bmatrix}
-1&r\Delta^2+2&-1&\dots&0&0&0
\end{bmatrix}\cdot u &= x_1\\
\begin{bmatrix}
0&0&0&\cdots&-1&r\Delta^2+2&-1
\end{bmatrix}\cdot u& = x_I
\end{cases}\\
&\begin{cases}
x_0 &= (r\Delta^2+1)x_1-x_2\\
x_{I+1}&=(r\Delta^2+1)x_I-x_{I_1}
\end{cases}
\end{align}
Thus, $Q$ is defined by $Q\cdot R\cdot\hat{u} = \hat{u}$, where
\begin{equation}
Q = \begin{bmatrix}
r\Delta^2+1&-1&\cdots&0&0\\
1&0&\cdots&0&0\\
0&1&\cdots&0&0\\
\vdots&\vdots&\ddots&\vdots&\vdots\\
0&0&\cdots&1&0\\
0&0&\cdots&0&1\\
0&0&\cdots&-1&r\Delta^2+1
\end{bmatrix}_{\hat{I}\times I}
\end{equation}
