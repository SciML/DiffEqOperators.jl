...
@testset "2D Multiplication with no boundary points and dx = 1.0" begin
    ...
    @test M_temp ≈
          ((Lx * M)[1:N, 2:(N + 1)] + (Ly * M)[2:(N + 1), 1:N] + (Lxx * M)[1:N, 2:(N + 1)] +
           (Lyy * M)[2:(N + 1), 1:N])
end
...
@testset "2D Multiplication with identical bpc and dx = 1.0" begin
    ...
    @test M_temp ≈ ((Lx3 * M)[1:N, 2:(N + 1)] + (Ly3 * M)[2:(N + 1), 1:N] +
           (Lx4 * M)[1:N, 2:(N + 1)] + (Ly4 * M)[2:(N + 1), 1:N])
...
@testset "2D Multiplication with differing bpc and dx = 1.0" begin
    ...
    @test M_temp ≈ ((Lx2 * M)[1:N, 2:(N + 1)] + (Ly2 * M)[2:(N + 1), 1:N] +
           (Lx3 * M)[1:N, 2:(N + 1)] + (Ly3 * M)[2:(N + 1), 1:N] +
           (Lx4 * M)[1:N, 2:(N + 1)] + (Ly4 * M)[2:(N + 1), 1:N])
end
...
@testset "2D Multiplication with differing bpc and non-trivial dx = 0.1, dy = 0.25" begin
    ...
    mul!(M_temp, A, M)
    @test M_temp ≈ ((Lx2 * M) + (Lx4 * M)) ||
          maximum(abs.(M_temp - ((Lx2 * M) + (Lx4 * M)))) < 1e-10
...
@testset "x and y are both irregular grids" begin
    ...
    M_temp = zeros(N, N)
    mul!(M_temp, A, M)
    @test M_temp ≈ ((Lx2 * M)[1:N, 2:(N + 1)] + (Lx3 * M)[1:N, 2:(N + 1)] +
           (Lx4 * M)[1:N, 2:(N + 1)] + (Ly2 * M)[2:(N + 1), 1:N] +
           (Ly3 * M)[2:(N + 1), 1:N] + (Ly4 * M)[2:(N + 1), 1:N])
end
...
@testset "regular x grid (dx=0.25) and irregular y grid" begin
    ...
    A += _Lx2 + _Lx3 + _Lx4
    mul!(M_temp, A, M)
    @test M_temp ≈ ((_Lx2 * M)[1:N, 2:(N + 1)] + (_Lx3 * M)[1:N, 2:(N + 1)] +
           (_Lx4 * M)[1:N, 2:(N + 1)] + (Lx2 * M)[1:N, 2:(N + 1)] +
           (Lx3 * M)[1:N, 2:(N + 1)] + (Lx4 * M)[1:N, 2:(N + 1)] +
           (Ly2 * M)[2:(N + 1), 1:N] + (Ly3 * M)[2:(N + 1), 1:N] +
           (Ly4 * M)[2:(N + 1), 1:N])
end
...
@testset "irregular x grid and regular y grid (dy = 0.25)" begin
    ...
    @test M_temp ≈ ((Lx2 * M)[1:N, 2:(N + 1)] + (Lx3 * M)[1:N, 2:(N + 1)] +
           (Lx4 * M)[1:N, 2:(N + 1)] + (Ly2 * M)[2:(N + 1), 1:N] +
           (Ly3 * M)[2:(N + 1), 1:N] + (Ly4 * M)[2:(N + 1), 1:N] +
           (_Ly2 * M)[2:(N + 1), 1:N] + (_Ly3 * M)[2:(N + 1), 1:N] +
           (_Ly4 * M)[2:(N + 1), 1:N])
end
...
@testset "3D Multiplication with no boundary points and dx = dy = dz = 1.0" begin
    ...
    @test M_temp ≈
          ((Lxx * M)[1:N, 2:(N + 1), 2:(N + 1)] + (Lyy * M)[2:(N + 1), 1:N, 2:(N + 1)] +
           (Lzz * M)[2:(N + 1), 2:(N + 1), 1:N])
    ...
    @test M_temp ≈ ((Lx * M)[1:N, 2:(N + 1), :] + (Ly * M)[2:(N + 1), 1:N, :] +
           (Lxx * M)[1:N, 2:(N + 1), :] + (Lyy * M)[2:(N + 1), 1:N, :])
    ...
    @test M_temp ≈ ((Lx * M)[1:N, :, 2:(N + 1)] + (Lxx * M)[1:N, :, 2:(N + 1)] +
           (Lz * M)[2:(N + 1), :, 1:N] + (Lzz * M)[2:(N + 1), :, 1:N])
    ...
    @test M_temp ≈ ((Ly * M)[:, 1:N, 2:(N + 1)] + (Lyy * M)[:, 1:N, 2:(N + 1)] +
           (Lz * M)[:, 2:(N + 1), 1:N] + (Lzz * M)[:, 2:(N + 1), 1:N])
    ...
    @test M_temp ≈
          ((Lx * M)[1:N, 2:(N + 1), 2:(N + 1)] + (Ly * M)[2:(N + 1), 1:N, 2:(N + 1)] +
           (Lxx * M)[1:N, 2:(N + 1), 2:(N + 1)] + (Lyy * M)[2:(N + 1), 1:N, 2:(N + 1)] +
           (Lz * M)[2:(N + 1), 2:(N + 1), 1:N] + (Lzz * M)[2:(N + 1), 2:(N + 1), 1:N])
end
...
@testset "3D Multiplication with identical bpc and dx = dy = dz = 1.0" begin
    ...
    @test M_temp ≈ ((Lx3 * M)[1:N, :, 2:(N + 1)] + (Lz3 * M)[2:(N + 1), :, 1:N] +
           (Lx4 * M)[1:N, :, 2:(N + 1)] + (Lz4 * M)[2:(N + 1), :, 1:N])
    ...
    @test M_temp ≈ ((Ly3 * M)[:, 1:N, 2:(N + 1)] + (Lz3 * M)[:, 2:(N + 1), 1:N] +
           (Ly4 * M)[:, 1:N, 2:(N + 1)] + (Lz4 * M)[:, 2:(N + 1), 1:N])
    ...
    @test M_temp ≈
          ((Lx3 * M)[1:N, 2:(N + 1), 2:(N + 1)] + (Ly3 * M)[2:(N + 1), 1:N, 2:(N + 1)] +
           (Lz3 * M)[2:(N + 1), 2:(N + 1), 1:N])
    ...
    @test M_temp ≈
          ((Lx4 * M)[1:N, 2:(N + 1), 2:(N + 1)] + (Ly4 * M)[2:(N + 1), 1:N, 2:(N + 1)] +
           (Lz4 * M)[2:(N + 1), 2:(N + 1), 1:N])
    ...
    @test M_temp ≈
          ((Lx3 * M)[1:N, 2:(N + 1), 2:(N + 1)] + (Ly3 * M)[2:(N + 1), 1:N, 2:(N + 1)] +
           (Lz3 * M)[2:(N + 1), 2:(N + 1), 1:N] + (Lx4 * M)[1:N, 2:(N + 1), 2:(N + 1)] +
           (Ly4 * M)[2:(N + 1), 1:N, 2:(N + 1)] + (Lz4 * M)[2:(N + 1), 2:(N + 1), 1:N])
end
...
@testset "3D Multiplication with differing bpc and dx = dy = dz = 1.0" begin
    ...
    @test M_temp ≈ ((Lx2 * M)[1:N, :, 2:(N + 1)] + (Lz2 * M)[2:(N + 1), :, 1:N] +
           (Lx3 * M)[1:N, :, 2:(N + 1)] + (Lz3 * M)[2:(N + 1), :, 1:N] +
           (Lx4 * M)[1:N, :, 2:(N + 1)] + (Lz4 * M)[2:(N + 1), :, 1:N])
    ...
    @test M_temp ≈ ((Ly2 * M)[:, 1:N, 2:(N + 1)] + (Lz2 * M)[:, 2:(N + 1), 1:N] +
           (Ly3 * M)[:, 1:N, 2:(N + 1)] + (Lz3 * M)[:, 2:(N + 1), 1:N] +
           (Ly4 * M)[:, 1:N, 2:(N + 1)] + (Lz4 * M)[:, 2:(N + 1), 1:N])
    ...
    mul!(M_temp, A, M)
    @test M_temp ≈
          ((Lx2 * M)[1:N, 2:(N + 1), 2:(N + 1)] + (Ly2 * M)[2:(N + 1), 1:N, 2:(N + 1)] +
           (Lz2 * M)[2:(N + 1), 2:(N + 1), 1:N] + (Lx3 * M)[1:N, 2:(N + 1), 2:(N + 1)] +
           (Ly3 * M)[2:(N + 1), 1:N, 2:(N + 1)]
           + (Lz3 * M)[2:(N + 1), 2:(N + 1), 1:N] + (Lx4 * M)[1:N, 2:(N + 1), 2:(N + 1)] +
           (Ly4 * M)[2:(N + 1), 1:N, 2:(N + 1)]) + (Lz4 * M)[2:(N + 1), 2:(N + 1), 1:N]
end
...
@testset "x, y, and z are all irregular grids" begin
    ...
    @test M_temp≈((Lx2 * M)[1:N, 2:(N + 1), :] + (Ly2 * M)[2:(N + 1), 1:N, :] +
                  (Lx3 * M)[1:N, 2:(N + 1), :] + (Ly3 * M)[2:(N + 1), 1:N, :] +
                  (Lx4 * M)[1:N, 2:(N + 1), :] + (Ly4 * M)[2:(N + 1), 1:N, :]) rtol=1e-3
...
@testset "irregular x grid and regular y and z grids (dy = 0.25, dz = 0.05)" begin
    ...
    mul!(M_temp, A, M)
    @test M_temp ≈ ((Lx2 * M)[1:N, :, 2:(N + 1)] + (Lx3 * M)[1:N, :, 2:(N + 1)] +
           (Lx4 * M)[1:N, :, 2:(N + 1)] + (Lz2 * M)[2:(N + 1), :, 1:N] +
           (Lz3 * M)[2:(N + 1), :, 1:N] + (Lz4 * M)[2:(N + 1), :, 1:N])
    ...
    @test M_temp ≈
          ((Lx2 * M)[1:N, 2:(N + 1), 2:(N + 1)] + (Ly2 * M)[2:(N + 1), 1:N, 2:(N + 1)] +
           ...
           + (Lz3 * M)[2:(N + 1), 2:(N + 1), 1:N] + (Lx4 * M)[1:N, 2:(N + 1), 2:(N + 1)] +
           (Ly4 * M)[2:(N + 1), 1:N, 2:(N + 1)] + (Lz4 * M)[2:(N + 1), 2:(N + 1), 1:N] +
           (_Ly2 * M)[2:(N + 1), 1:N, 2:(N + 1)] + (_Lz3 * M)[2:(N + 1), 2:(N + 1), 1:N] +
           (_Ly4 * M)[2:(N + 1), 1:N, 2:(N + 1)])
end
...
@testset "irregular y grid and regular x and z gris (dx = 0.25, dz = 0.05)" begin
    ...
    @test M_temp ≈ ((Ly2 * M)[:, 1:N, 2:(N + 1)] + (Ly3 * M)[:, 1:N, 2:(N + 1)] +
           (Ly4 * M)[:, 1:N, 2:(N + 1)] + (Lz2 * M)[:, 2:(N + 1), 1:N] +
           (Lz3 * M)[:, 2:(N + 1), 1:N] + (Lz4 * M)[:, 2:(N + 1), 1:N])
    ...
    mul!(M_temp, A, M)
    @test M_temp ≈ ((Ly2 * M)[:, 1:N, 2:(N + 1)] + (Ly3 * M)[:, 1:N, 2:(N + 1)] +
           (Ly4 * M)[:, 1:N, 2:(N + 1)] + (Lz3 * M)[:, 2:(N + 1), 1:N])
    ...
    M_temp = zeros(N + 2, N, N)
    mul!(M_temp, A, M)
    @test M_temp ≈ ((Ly3 * M)[:, 1:N, 2:(N + 1)] + (Lz2 * M)[:, 2:(N + 1), 1:N] +
           (Lz3 * M)[:, 2:(N + 1), 1:N] + (Lz4 * M)[:, 2:(N + 1), 1:N])
    ...
    M_temp = zeros(N + 2, N, N)
    mul!(M_temp, A, M)
    @test M_temp ≈ ((Ly4 * M)[:, 1:N, 2:(N + 1)] + (Lz2 * M)[:, 2:(N + 1), 1:N] +
           (Lz3 * M)[:, 2:(N + 1), 1:N] + (Lz4 * M)[:, 2:(N + 1), 1:N])
    # It seems that the y paddign could be the issue
    ...
    M_temp = zeros(N + 2, N, N)
    mul!(M_temp, A, M)
    @test M_temp ≈ ((Ly3 * M)[:, 1:N, 2:(N + 1)] + (Ly4 * M)[:, 1:N, 2:(N + 1)] +
           (Lz2 * M)[:, 2:(N + 1), 1:N] + (Lz3 * M)[:, 2:(N + 1), 1:N] +
           (Lz4 * M)[:, 2:(N + 1), 1:N])
    # It seems that the y paddign could be the issue
    ...
    M_temp = zeros(N + 2, N, N)
    mul!(M_temp, A, M)
    @test M_temp ≈ ((Ly2 * M)[:, 1:N, 2:(N + 1)] + (Ly4 * M)[:, 1:N, 2:(N + 1)] +
           (Lz2 * M)[:, 2:(N + 1), 1:N] + (Lz3 * M)[:, 2:(N + 1), 1:N] +
           (Lz4 * M)[:, 2:(N + 1), 1:N])
    # It seems that the y paddign could be the issue
    ...
    @test M_temp ≈
          ((Lx2 * M)[1:N, 2:(N + 1), 2:(N + 1)] + (Ly2 * M)[2:(N + 1), 1:N, 2:(N + 1)] +
           ...
           + (Lz3 * M)[2:(N + 1), 2:(N + 1), 1:N] + (Lx4 * M)[1:N, 2:(N + 1), 2:(N + 1)] +
           (Ly4 * M)[2:(N + 1), 1:N, 2:(N + 1)] + (Lz4 * M)[2:(N + 1), 2:(N + 1), 1:N] +
           (_Lx2 * M)[1:N, 2:(N + 1), 2:(N + 1)] + (_Lz3 * M)[2:(N + 1), 2:(N + 1), 1:N] +
           (_Lx4 * M)[1:N, 2:(N + 1), 2:(N + 1)])
end
