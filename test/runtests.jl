...
#     A = DiffEqLinearOperator{Float64}(d_order,approx_order,1.0,N,:Dirichlet0,:Dirichlet0)
#     mat = full(A)
#     sp_mat = sparse(A)
#     @test mat == sp_mat;
...
#     A = DiffEqLinearOperator{BigFloat}(d_order,approx_order,one(BigFloat),N,:Dirichlet0,:Dirichlet0)
...
#     A = DiffEqLinearOperator{Float64}(d_order,approx_order,dx,length(xarr),:None,:None)
#     B = DiffEqLinearOperator{Float64}(d_order,approx_order,dy,length(yarr),:None,:None)
